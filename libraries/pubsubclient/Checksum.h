...
static const uint32_t crc_32_tab[] PROG_MEM = { /* CRC polynomial 0xedb88320 */
...
inline void crc32(uint32_t &oldcrc32,char c,unsigned long &charcnt)
...
inline int uintToHexStr(unsigned int num,char* buff)
{
    int len=0,k=0;
    do//for every 4 bits
    {
